...
public class Perpustakaan {
    ...
    public void pinjamBuku(String judul) {
        for (Buku b : koleksi) {
            // DIUBAH: Menggunakan == agar lebih sederhana
            if (b.getJudul() == judul) { 
                if (b.isDipinjam()) {
    ...
    // 1. Method Tambahan: Mengembalikan Buku
    ...
    // 3. Method Tambahan: Mencari Buku Berdasarkan Penulis
    public void cariPenulis(String penulis) {
        ...
        if (!ditemukan) {
            System.out.println("Tidak ada buku dari penulis " + penulis + " di perpustakaan.");
        }
    }
